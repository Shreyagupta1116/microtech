<?php
  class my_less extends lessc {
    ...
    public function load_defaults()
    {
      ...
      require_once( get_template_directory() . "/inc/default-less-vars.php");
      // load custom variables you want to override
      require_once( get_template_directory() . '/extend/custom-php-vars.php' );
    ...
    function my_less_vars( $vars, $handle ) {
      ...
      $vars[ 'buttonsFontFamily' ]             = $this->custom_or_default('buttons_font_family' , 'buttonsFontFamily');
      $vars[ 'buttonsFontWeightNormal' ]       = $this->custom_or_default('buttons_font_weight_normal' , 'buttonsFontWeightNormal');
      $vars[ 'buttonsFontWeightBold' ]         = $this->custom_or_default('buttons_font_weight_bold' , 'buttonsFontWeightBold');
      ...
      $vars[ 'buttonsBaseFontSize' ]        = $this->add_px($this->custom_or_default('buttons_base_font_size' , 'buttonsBaseFontSize'));
      ...
      $vars[ 'headingsTextTransform' ]      = osetin_get_field('make_headings_uppercased', 'option') ? 'uppercase' : 'none';
      $vars[ 'buttonsTextTransform' ]       = osetin_get_field('make_buttons_lowercased', 'option') ? 'none' : 'uppercase';
      ...
      // PANEL SIZES
      $vars[ 'contentLeftWidth' ]           = $this->add_px($this->custom_or_default('left_panel_width' , 'contentLeftWidth'));
      $vars[ 'contentMiddleWidth' ]         = $this->add_px($this->custom_or_default('middle_panel_width' , 'contentMiddleWidth'));
      $vars[ 'contentThumbsWidth' ]         = $this->add_px($this->custom_or_default('thumbs_panel_width' , 'contentThumbsWidth'));
      $vars[ 'menuOnTheLeftWidth' ]         = $this->add_px($this->custom_or_default('menu_left_width' , 'menuOnTheLeftWidth'));
      $vars[ 'slideoutMenuWidth' ]         = $this->add_px($this->custom_or_default('slideout_menu_width' , 'slideoutMenuWidth'));

      $vars[ 'buttonsCTABorderRadius' ] = osetin_get_field('make_buttons_squared', 'option') ? '0px' : '8px';
