 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Lawyer by Osetin for publication on ThemeForest
...
add_action( 'tgmpa_register', 'lawyer_by_osetin_register_required_plugins' );
/**
 ...
 */
function lawyer_by_osetin_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/inc/plugins/osetin-helper.zip', // The plugin source.
        ...
        // Activating ACF
        array(
            'name'               => __('Advanced Custom Fields Pro', 'moon'), // The plugin name.
        ...
        array(
            ...
            'source'             => get_template_directory() . '/inc/plugins/birchschedule.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
