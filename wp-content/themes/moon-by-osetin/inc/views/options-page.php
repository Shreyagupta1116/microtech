<div class="wrap about-wrap">
  ...
  if(isset($current_theme)){
    $welcome_str = 'Welcome to Moon v'.$current_theme->get( 'Version' );
  }else{
    $welcome_str = 'Welcome';
  }
  ...
  ?>
	...
	<div class="about-text">Congratulations! You are using the most powerful photography portfolio &amp; blog theme on the market built for you by a great team at <a href="https://pinsupreme.com">Pinsupreme.com</a></div>
  ...
  <div class="osetin-intro-box activate-theme-box">
    ...
    <div class="theme-activation-status <?php if($cerberus->last_status_code == 200) echo 'theme-activated'; ?>"><?php echo $cerberus->last_status_message;?></div>

    <div class="cerberus-code-w">
      <input placeholder="Enter your license key here..." type="text" value="<?php echo $cerberus->license_key; ?>" class="cerberus_code">
      <div class="cerberus-code-btn-w">
        <a href="#" class="button button-primary button-large cerberus-trigger-code-btn"><?php _e("Activate",'sun'); ?></a>
        <div class="spinner"></div>
      </div>
    </div>
    <div class="how-to-find-license">
      <a href="https://pinsupreme.com/posts/how-to-find-your-themeforest-item-purchase-license-code" target="_blank">How to find your license key?</a>
    </div>
  </div>
  <?php } ?>
  <div class="osetin-intro-box">
    ...
    <ul>
      <li><a href="http://moon.pinsupreme.com/docs/index.html" target="_blank">Read Documentation</a></li>
      <?php if ( !defined('ENVATO_HOSTED_SITE') ) { ?>
      <li><a href="https://pinsupreme.com/users/sign_up" target="_blank">Create Account to Manage Activations</a></li>
      <?php } ?>
      <li><a href="http://moon.pinsupreme.com/docs/index.html#headingFaqs" target="_blank">Read FAQ</a></li>
  ...
  <div class="osetin-intro-box">
    ...
    <a href="http://moon.pinsupreme.com/docs/index.html#headingImportingDemoDataXML" target="_blank">Learn How to Import Demo Data</a>
  </div>
