...
function register_cloudlyup_gmap_settingspage_fields() {
   add_option( 'gmap_api_key', 'api key');
   register_setting( 'myplugin_options_group', 'gmap_api_key');

	 add_option( 'gmap_zoom', 'max value 10');
...
<form method="post" action="options.php">
  ...
  <td><input type="text" class="gmap_settings_field" id="gmap_api_key" name="gmap_api_key" value="<?php echo get_option('gmap_api_key'); ?>" /></td>
	</tr>
	<tr valign="top">
	<th scope="row"><label class="gmap_labal_field" for="gmap_zoom">Google zoom</label></th>
  <td><input type="text" class="gmap_zoom" id="gmap_zoom" name="gmap_zoom" value="<?php echo get_option('gmap_zoom'); ?>" /></td>
  </tr>
  </table>
  <?php  submit_button(); ?>
  </form>
